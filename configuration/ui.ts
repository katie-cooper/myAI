...
export const CHAT_HEADER: string = `SmartTax Assistant`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI Tax Assistant by Katie Fort @ UNC`;
export const CLEAR_BUTTON_TEXT: string = `Reset Conversation History`;
export const PAGE_TITLE: string = `SmartTax Assistant Chat`;
