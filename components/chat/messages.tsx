...
function AILogo() {
  return (
    <div className="w-9 h-9">
      <Image src="/blue pencil.png" alt={AI_NAME} width={36} height={36} />
    </div>
  );
}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="px-3 py-1 bg-[#2c92d1] rounded-2xl text-white max-w-[60%] shadow-sm hover:shadow-md transition-shadow duration-300"
      >
        {message.content}
      </motion.div>
    </motion.div>
